...
def _to_values(data: Union[Mapping[str, Number], Sequence[Number]]) -> np.ndarray:
...
def invariance_gap(train_env_risks: Union[Mapping[str, Number], Sequence[Number]]) -> float:
...
def worst_group_gap(
    train_env_risks: Union[Mapping[str, Number], Sequence[Number]],
    test_env_risks: Union[Mapping[str, Number], Sequence[Number]],
) -> float:
